...
// FindAll provides a mock function with given fields: email
func (_m *UserRepository) FindAll(email string) []model.UserData {
	ret := _m.Called(email)
...
func (_m *UserRepository) FindById(id string) (*model.UserData, error) {
	ret := _m.Called(id)
